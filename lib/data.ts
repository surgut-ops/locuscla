export const ALL_CITIES = [
  ...
  'Ставрополь', 'Белгород', 'Нижний Тагил', 'Архангельск', 'Владимир',
  'Сочи', 'Сургут', 'Чита', 'Улан-Удэ', 'Якутск', 'Смоленск', 'Калуга',
  'Мурманск', 'Орёл', 'Вологда', 'Саранск', 'Нальчик', 'Череповец',
  'Владикавказ', 'Грозный', 'Тамбов', 'Стерлитамак', 'Кострома', 'Химки',
  'Нижневартовск', 'Новороссийск', 'Йошкар-Ола', 'Балашиха', 'Таганрог',
  'Люберцы', 'Мытищи', 'Комсомольск-на-Амуре', 'Петрозаводск', 'Сыктывкар',
  'Псков', 'Великий Новгород', 'Рыбинск', 'Бийск', 'Подольск', 'Королёв',
  'Одинцово', 'Красногорск', 'Домодедово', 'Электросталь', 'Коломна',
  'Долгопрудный', 'Дзержинск', 'Волжский', 'Шахты', 'Орск', 'Нижнекамск',
  'Энгельс', 'Прокопьевск', 'Благовещенск', 'Братск', 'Ангарск', 'Мурино',
  'Альметьевск', 'Серпухов', 'Курган', 'Старый Оскол', 'Балаково',
];
...
// Unique amenities from all listings (for wizard)
export const AMENITIES = [
  'Wi-Fi', 'Стиральная машина', 'Холодильник', 'Кондиционер', 'Телевизор', 'Мебель',
  'Посудомойка', 'Можно с животными', 'Балкон', 'Паркинг', 'Консьерж',
  'Баня', 'Беседка', 'Камин',
];
